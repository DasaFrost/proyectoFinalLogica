...
def jugarContraComputadora():
    ...
    while True:
        if turnoJugador:
            ...
            resultado = realizarDisparos(tableroComputadora, tableroDisparosJugador, fila, columna)
            ...
            resultado = realizarDisparos(tableroJugador, tableroDisparosComputadora, fila, columna)
...
def jugarDosJugadores():
    ...
    while True:
        if turnoJugador:
            ...
            fila = int(input("Ingresa la fila del disparo: "))
            columna = int(input("ingresa la columna del disparo: "))
            resultado = realizarDisparos(tableroJugador2, tableroDisparosJugador1, fila, columna)
            if verificarVictoria(tableroJugador2):
                print("Jugador 1 gano")
                return "Jugador 1"
        else:
            print("\n Turno de la Jugador 2")
            mostrarTableros(tableroDisparosJugador2, tableroDisparosJugador1)
            fila = int(input("Ingresa la fila del disparo: "))
            columna = int(input("ingresa la columna del disparo: "))
            resultado = realizarDisparos(tableroJugador1, tableroDisparosJugador2, fila, columna)
            print(resultado)
        ...
        turnoJugador1 = not turnoJugador1
def mostrarMenu():
    print("Bienvenido a Batallas Naval!!! ")
...
def iniciarJuego():
    while True:
        ...
        if modo == "1":
            ...
            print("Gracias por jugar con ricky Ricon")
            break
        else:
        ...
        if JugarDeNuevo !="s":
            print("Gracias por jugar ricky Ricon, Hasta la vista Baby")
            break
